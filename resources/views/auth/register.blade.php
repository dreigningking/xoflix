    ...
    <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('register')}}" id="kt_sign_up_form"
        ...
        <div class="row fv-row mb-7 fv-plugins-icon-container">
            ...
            <div class="col-xl-6">
                ...
                <input class="form-control form-control-lg" type="text" value="{{ old('firstname') }}" name="firstname" autocomplete="off">
                @error('firstname')
            ...
            <div class="col-xl-6">
                ...
                <input class="form-control form-control-lg" type="text" value="{{ old('lastname') }}" name="lastname" autocomplete="off">
                @error('lastname')
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback d-block">
                    <strong>{{ $message }}</strong>
                </div>  
        ...
        <div class="fv-row mb-7 fv-plugins-icon-container">
            ...
            <input class="form-control form-control-lg " type="email" value="{{ old('email') }}" name="email" autocomplete="off">
            @error('email')
            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback d-block">
                <strong>{{ $message }}</strong>
            </div>  
