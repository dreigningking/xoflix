                    ...
                    <div class="card-header" id="kt_chat_messenger_header">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex justify-content-center flex-column me-3">
                                <a href="#"
                                    class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{$user->name}}</a>
                                    ...
                                    <div class="d-flex justify-content-start mb-10 ">
                                        ...
                                        <div class="d-flex flex-column align-items-start">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <!--begin::Details-->
                                                <div class="ms-3">
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">{{ $user->name }} </a>
                                                    <span class="text-muted fs-7 mb-1">{{$support->created_at->calendar()}}</span>
                                                </div>
                                                <!--end::Details-->
...
@push('scripts')
    <script>
        ...
        $(document).on('click','#send',function(){
            ...
            let image = `<span class="symbol-label  bg-danger text-white fs-6 fw-bolder ">X</span>`
