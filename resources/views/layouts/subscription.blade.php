    ...
    <div class="card-body px-5 px-lg-20 pt-17 pb-10">
        <div class="py-5">
                ...
                <div class="d-flex flex-md-row rounded border">
                    ...
                    <ul class="nav nav-tabs nav-pills w-100 flex-row border-0 mb-md-0 fs-6" role="tablist">
                        ...
                        <li class="nav-item w-50 me-0" role="presentation">
                            <a class="nav-link w-100 btn btn-flex btn-active-light-info active" data-bs-toggle="tab" href="#kt_vtab_pane_5" aria-selected="false" role="tab" tabindex="-1">
                                <i class="ki-duotone ki-icons/duotune/general/gen003.svg fs-2 text-primary me-3"></i>                        <span class="d-flex flex-column align-items-start">
                        ...
                        <li class="nav-item w-50 me-0" role="presentation">
                            <a class="nav-link w-100  btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#kt_vtab_pane_4" aria-selected="false" role="tab" tabindex="-1">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade active show px-3" id="kt_vtab_pane_5" role="tabpanel">
